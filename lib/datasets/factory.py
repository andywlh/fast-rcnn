...
inria_devkit_path = '/home/qqxiao/INRIA'
...
a6l_accord_devkit_path = '/home/qqxiao/A6L_ACCORD'
for split in ['train', 'test']:
    name = '{}_{}'.format('a6l_accord', split)
    __sets[name] = (lambda split=split: datasets.a6l_accord(split, a6l_accord_devkit_path))

towncenter_devkit_path = '/home/qqxiao/TownCenter'
for split in ['test']:
